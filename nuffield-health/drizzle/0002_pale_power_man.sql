...
--> statement-breakpoint
CREATE INDEX `idx_bupa_consultants_reg` ON `bupa_consultants` (`registration_number`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_matches_nuffield_slug` ON `consultant_matches` (`nuffield_slug`);
--> statement-breakpoint
CREATE INDEX `idx_matches_bupa_id` ON `consultant_matches` (`bupa_id`);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `consultant_photos` (
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `consultant_photos_slug_unique` ON `consultant_photos` (`slug`);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `profile_rewrites` (
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_rewrites_slug_run` ON `profile_rewrites` (`slug`,`run_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_rewrites_status` ON `profile_rewrites` (`status`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_sources_slug_rewrite` ON `research_sources` (`slug`,`rewrite_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_sources_corroborated` ON `research_sources` (`corroborated`);
--> statement-breakpoint
